...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setLogo(R.drawable.ic_location_off_black_24dp);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.action_settings) {
           /* FirebaseAuth.getInstance().signOut();
            ...
            finish();*/
            return true;
        }else if(i == R.id.location_permissions){
            showSettingsDialog();
            return true;
        } else {
    ...
    private void initLocationPermissionCheckbox(){
        // Initialize location permissions checkbox
    ...
    private void initSwitchState(View v){
        // Initialize the switch state and Handle enable/disable switch change
        Switch onOffSwitch =  v.findViewById(R.id.enable_switch);
    ...
    private void showSettingsDialog(){
        ...
        builder.setView(v);
        try{
            initLocationPermissionCheckbox();
            initSwitchState(v);
        }catch (Exception e){
            e.printStackTrace();
        }
